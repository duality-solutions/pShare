...
export const takeBatch = <T>(patOrChan: Pattern | Channel<T>, opts: Partial<TakeBatchOptions> = {}) => {
    ...
    return call(function* () {
        ...
        const batchMaxDelay = maxDurationMs != null ? delay(maxDurationMs) : neverEffect;
        ...
        for (; ;) {
            ...
            const { evt, nextMessageTimeout, maxTimeout, }: RaceResult = yield race({
                evt: takeFx,
