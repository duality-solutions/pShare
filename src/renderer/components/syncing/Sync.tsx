...
export interface SyncStateProps {
  ...
  isComplete: boolean
  rpcClientFailed: boolean
  rpcClientFailureMessage?: string
}
...
export const Sync: React.FunctionComponent<SyncProps> =
  ({ progressPercent, isComplete, syncStarted, rpcClientFailed, rpcClientFailureMessage }) =>
    <>
        ...
        <Container height="60vh">
          <Box direction="column" width="100%" align="center">
            <Box direction="row" width="100%" align="center">
              {
                rpcClientFailed ?
                  <Text align="center">Could not start RPC client. Reason : {rpcClientFailureMessage}</Text> :
                  syncStarted ?
                    !isComplete ?
