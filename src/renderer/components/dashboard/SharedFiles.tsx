...
export const SharedFiles: FunctionComponent<SharedFilesProps> = ({ close, requestFile, shareNewFile, outFiles, linkedUserName, userName, linkedUserCommonName, downloadableFiles, sharedFilesFetchState }) => {
