...
export const QRCode: React.FunctionComponent<IProps> = (props) => {
    ...
    return <div style={{ display: "inline-block", ...props.style, background: props.bgColor }}>
        <canvas
            height={actualSize}
            width={actualSize}
            style={{
                ...
                width: actualSize + 'px',
                padding: (props.minPadding! + Math.max(0, ((size! - actualSize) / 2))) + 'px',
