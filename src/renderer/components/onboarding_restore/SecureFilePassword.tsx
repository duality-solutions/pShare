...
export const SecureFilePassword: FunctionComponent<SecureFilePasswordProps> = ({ secureFilePasswordCancelled, isValidating, validationResult, restoreSync, mnemonicRestoreFilePassphraseSubmitted }) => {
