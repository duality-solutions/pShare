...
export interface RestoreUsingPassphraseStateProps {
    isValidating: boolean,
    validationResult?: ValidationResult<string>
}
export interface RestoreUsingPassphraseDispatchProps {

}
type RestoreUsingPassphraseProps = RestoreUsingPassphraseDispatchProps & RestoreUsingPassphraseStateProps

interface RestoreUsingPassphraseComponentState {

}

export class RestoreUsingPassphrase extends Component<RestoreUsingPassphraseProps, RestoreUsingPassphraseComponentState>{
    constructor(props: RestoreUsingPassphraseProps) {
        super(props)
    }
