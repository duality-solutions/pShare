...
export const RestoreAccount:React.FunctionComponent<RestoreAccountProps> = 
    ({ restoreWithPassphrase, restoreWithMnemonicFile }) =>
    <>
    ...
    <Box display="flex" direction="row" align="center" width="100%">
        <SCard onClick={()=> restoreWithPassphrase()} padding="2em 1em 0em 1em" height="140px" width="220px">
        ...
        <SCard onClick={()=> restoreWithMnemonicFile()} padding="2em 1em 0em 1em" height="140px" width="220px">
