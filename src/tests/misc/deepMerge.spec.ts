...
test("treats arrays as unmergeable", () =>
    expect(deepMerge([1, 2], [3, 4])).toEqual([3, 4]));
test("treats numbers as unmergeable", () => expect(deepMerge(1, 2)).toEqual(2));
test("throws with mixed mergeable/unmergeable items", () =>
    expect(() => deepMerge({ a: 1 }, 2 as any)).toThrow());
test("throws with mixed mergeable/unmergeable items, deep in graph", () =>
    expect(() => deepMerge({ a: { b: 2 } }, { a: 1 })).toThrow());
...
const badData = [
    {
        ...
        out: {
            emptyfile: {
                ...
                path:
                    "/home/spender/.pshare/share/hfchrissperry1001/out/emptyfile",
                relativePath: "emptyfile",
                sharedWith: "hfchrissperry1001",
                size: 0,
            },
        },
    },
